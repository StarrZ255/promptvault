...
contextBridge.exposeInMainWorld('vault', {
  prompts: {
    ...
    getSuppressed:         ()               => invoke('prompts:getSuppressed'),
    hideBatch:             (ids: string[])  => invoke('prompts:hideBatch', ids),
    restoreHidden:         (id: string)     => invoke('prompts:restoreHidden', id),
    suppressBuiltins:      ()               => invoke('prompts:suppressBuiltins'),
